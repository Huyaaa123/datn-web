...
<head>
    ...
    <!-- Favicon -->
    <link href="../fpoly-theme-main/clients/eshopper/img/favicon.ico" rel="icon" />
    ...
    <link href="../fpoly-theme-main/clients/eshopper/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="../fpoly-theme-main/clients/eshopper/css/style.css" rel="stylesheet" />
</head>
...
<body>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold">
                        <span class="font-weight-bold border px-3 mr-1">Rolex</span><span
                            class="text-primary">Watch</span>
                    </h1>
                </a>
            </div>
        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                <a href="" class="text-decoration-none d-block d-lg-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold">
                        <span class="text-primary font-weight-bold border px-3 mr-1">Rolex</span>Watch
                    </h1>
                </a>
            ...
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold">
                        <span class=" font-weight-bold border border-white px-3 mr-1">Rolex</span><span
                            class="text-primary">Watch</span>
                    </h1>
                </a>
                <p>
    ...
    <script src="../fpoly-theme-main/clients/eshopper/lib/easing/easing.min.js"></script>
    <script src="../fpoly-theme-main/clients/eshopper/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="../fpoly-theme-main/clients/eshopper/mail/jqBootstrapValidation.min.js"></script>
    <script src="../fpoly-theme-main/clients/eshopper/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="../fpoly-theme-main/clients/eshopper/js/main.js"></script>
</body>
